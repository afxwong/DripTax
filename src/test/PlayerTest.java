...
public class PlayerTest {
    // Selects upper left tile and tests to see if it is selected, then it selects the tile again, and tests if it is
    // deselected
    @org.junit.jupiter.api.Test
    void testSelectTile() {
        // JFXPanel must be initialized or else a  will occur due to Labels being initialized before JavaFX is loaded
    ...
    // Selects the upper left tile, deselects the selected tile, tests if the selected tile is not what was selected
